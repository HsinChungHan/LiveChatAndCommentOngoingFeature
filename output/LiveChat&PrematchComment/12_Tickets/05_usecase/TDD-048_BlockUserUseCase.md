...
5. 實作將用戶加入黑名單 DB 的邏輯 / 實作將用戶加入黑名單 DB 的Logic
6. 實作 WebSocket 重連後同步 blocked user 清單的邏輯 / Implement WebSocket 重連後同步 blocked user 清單的Logic

## 驗收條件 / Acceptance Criteria

- [ ] UseCase 商業邏輯實作完成 / UseCase 商業LogicImplementation Complete
- [ ] 黑名單管理邏輯實作完成 / 黑名單管理LogicImplementation Complete
