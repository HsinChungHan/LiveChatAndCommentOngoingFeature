...
1. 定義 CommentMeta 結構 / Define CommentMeta Structure
2. 實作 Identifiable 和 Equatable / Implement Identifiable 和 Equatable
3. 定義所有必要欄位（id、commentCount、betCount、refId） / 定義所有RequiredFields(id, CommentCount, betCount, refId)

## 驗收條件 / Acceptance Criteria

- [ ] CommentMeta Entity 定義完成 / CommentMeta Entity Definition Complete
