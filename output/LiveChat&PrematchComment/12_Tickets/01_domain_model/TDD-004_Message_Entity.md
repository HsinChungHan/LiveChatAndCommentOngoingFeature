...
1. 定義 Message 結構 / Define Message Structure
2. 實作 Identifiable 和 Equatable / Implement Identifiable 和 Equatable
3. 定義所有必要欄位（id、content、messageNo、authorId 等） / 定義所有RequiredFields(id, content, messageNo, authorId 等)
4. 定義 MessageType enum / Define MessageType enum

## 驗收條件 / Acceptance Criteria

- [ ] Message Entity 定義完成 / Message Entity Definition Complete
